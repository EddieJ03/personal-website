...
function Experience() {
  return (
    <section className="p-10">
      <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-center text-gray-900 md:text-5xl lg:text-6xl dark:text-white md:mt-10 sm:mt-10">
      ...
      <div className="flex flex-col justify-center gap-10 py-10 lg:flex-row lg:flex-wrap">
        ...
        <div className="basis-1/3 flex-1 max-w-2xl">
          <div className="flex flex-col items-center shadow-xl p-10 rounded-xl border-4">
            <Image
              className="mb-3 w-24 h-24 shadow-lg rounded-full"
              src={ucsd}
              alt="UCSD Logo"
            />
            <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">
            ...
            <ul className="mt-5 max-w-lg list-disc text-gray-500 dark:text-gray-400">
              <li className="mb-2">
                Conducting research under Professor Ryan Kastner and Ph.D.
                student Jennifer Switzer to turn old Android phones into
                environmental sensors
              </li>
              <li className="mb-2">
                Testing and improving the NativeScript Task Dispatcher library
                to allow background sensing tasks to overcome limitations
              </li>
              <li>
                Collecting data to quantify the carbon emissions saved by
                repurposing old phones rather than making new sensors
              </li>
            </ul>
          </div>
        </div>
