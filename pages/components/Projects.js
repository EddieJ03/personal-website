...
const projects = [
  {
    ...
    description: "A self-hosted machine learning platform you can spin up on Azure using Pulumi.",
    links: [
      { icon: <AiFillGithub />, url: "https://github.com/EddieJ03/ml-infra" },
    ],
    tags: ["Pulumi", "TypeScript", "Docker", "Kubernetes", "Azure", "Poetry"],
  },
  {
    title: "Wrath of Zeus",
    image: wrathofzeus,
    alt: "Wrath of Zeus Pic",
    description: "A 3-v-1 asymmetric maze escape game where 3 players attempt to escape a maze while Zeus tries to stop them from above.",
    links: [
      { icon: <AiFillGithub />, url: "https://github.com/ucsd-cse125-sp24/group3" },
      { icon: <AiFillYoutube />, url: "https://www.youtube.com/watch?v=AMQor-28tAw&t=204s&ab_channel=TheQualcommInstitute" },
    ],
  ...
  },
  {
    ...
    image: president,
    alt: "President Pic",
    description: "A Transformer Decoder trained on multiple GPUs that completes a sentence like a popular president.",
    links: [
  ...
  },
  {
    ...
    image: bogglelive,
    alt: "Boggle Live Pic",
    description: "A real-time, two-player version of Boggle online that you can play with friends or family. Enabled real-time game streaming with Redpanda (lightweight Kafka-compatible streaming platform).",
    links: [
  ...
  },
  {
    ...
    image: younotes,
    alt: "ytnotes pic",
    description: "A Chrome Extension that allows you to take time-stamped notes while watching a YouTube video. All notes are also stored independently per video.",
    links: [
  ...
  },
  {
    ...
    image: raft,
    alt: "raft pic",
    description: "Implemented the Raft consensus protocol from scratch using Go and gRPC. Also wrote a suite of tests to ensure correctness.",
    links: [
      { icon: <AiFillGithub />, url: "https://github.com/EddieJ03/go-raft" },
      { icon: <AiOutlineLink />, url: "https://docs.google.com/document/d/1b9PiLlhFaiZRLAK0ExGCI6sORHdu5z758UHyFsg52-k/edit?usp=drive_link" },
    ],
    ...
    <section className="p-10">
      ...
      <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
        {projects.map((project, idx) => (
          <div key={idx} className="rounded-xl overflow-hidden shadow-lg basis-1/3 flex-1 border-4">
            <Image
            ...
            <div className="px-6 py-4">
              <div className="flex flex-row font-bold justify-center gap-5 items-center text-xl mb-2  dark:text-white">
                ...
                {project.links.map((link, i) => (
                  <div key={i} className="flex justify-center items-center bg-blue-400 h-6 w-6 rounded-full">
